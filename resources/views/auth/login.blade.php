...
<head>
  ...
  <!-- Font Awesome -->
  <link rel="stylesheet" href="{{ asset('public/vendor/adminlte/plugins/fontawesome-free/css/all.min.css') }}">
  <!-- icheck bootstrap -->
  <link rel="stylesheet" href="{{ asset('public/vendor/adminlte/plugins/icheck-bootstrap/icheck-bootstrap.min.css') }}">
  <!-- Theme style -->
...
<!-- AdminLTE App -->
<script src="{{ asset('public/vendor/dist/js/adminlte.min.js') }}"></script>
</body>
</html>
