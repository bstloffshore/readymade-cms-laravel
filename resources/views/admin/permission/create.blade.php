...
<div class="modal-body">
    <form method="POST" action="{{ route('module-settings.store') }}" accept-charset="UTF-8" id="ms_form" enctype="multipart/form-data">
        @csrf
        ...
        <div class="row">
            <div class="col-sm-6 col-xs-12 form-group @error('module_name') has-error @enderror">
                ...
                <input class="form-control" placeholder="Enter Module name" name="module_name" type="text" id="module_name">
                @error('module_name')
            ...
            <div class="col-sm-6 col-xs-12 form-group @error('module_slug') has-error @enderror">
                ...
                <input class="form-control" placeholder="Enter module slug" name="module_slug" type="text" id="module_slug">
                @error('module_slug')
                <span class="text-danger">{{ $message }}</span>
                @enderror
            </div>
        ...
        $(function () {
           ...
           $("#ms_form").validate({
               ...
               rules: {
                   ...
                   'module_slug': { required:true, normalizer: function(value) {return $.trim(value);},},
               },
               messages: {},
