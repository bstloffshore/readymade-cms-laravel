<div class="modal-header">
    <h3 class="modal-title" id="ajaxModalLabel">Edit User Group</h3>
    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
        <span aria-hidden="true">&times;</span>
    </button>
</div>
<div class="modal-body">
    <form method="POST" action="{{ route('roles.updateUserGroup') }}" accept-charset="UTF-8" id="validate_form" enctype="multipart/form-data">
        @csrf
        ...
        <div class="row">
            <div class="col-sm-12 col-xs-12 form-group @error('name') has-error @enderror">
                ...
                <input class="form-control" placeholder="Enter Name" name="name" type="text" id="name" value="{{$role->name}}">
                @error('name')
